// Skills Section Logo'sMore actions
...
//  import glaLogo from './assets/education_logo/gla_logo.png';
 import Hiet_Logo from './assets/education_logo/Hiet_logo.jpg';
 import gps_logo from './assets/education_logo/gps_logo.jpg';
  ...
  export const experiences = [
    {
      ...
      company: "Hexicom (freelance Project)",
      date: "Sep 2025 - Oct 2025",
      desc: "Designed and developed a web application for Hexicom as an independent freelancer.Built the frontend using React/Next.js, ensuring responsive UI and smooth user experience. Developed a secure Node.js/Express backend with REST APIs and integrated authentication.",
      skills: [
        "HTML",
        "CSS",
        "JavaScript",
  ...
  //   },
    {
      id: 1,
      img: Hiet_Logo,
      school: "HIET College Ghaziabad",
      Batch: "2021-25",
      grade: "60%",
      desc: "I completed my Bachelor's degree in Information Technology (B-Tech) from Hi-tech institute of engineering and technology Ghaziabad. Throughout my studies, I was immersed in a variety of subjects that deepened my understanding of computing and technology.My specialization in Web Development and Database Management Systems, I gained practical insights into the world of software development. My time at Hi-tech college allowed me to work on projects that applied theoretical concepts to real-world problems.",
      degree:  "B-tech (Information Technology)",
    },
    {
      id: 2,
      img: gps_logo,
      school: "Gurukul Public School Khair(Aligarh)",
      date: "2020-21",
      grade: "58%",
      desc: "I completed my class 12 education from Gurukul Public School, Aligarh, under the CBSE board, where I studied Physics, Chemistry, and Mathematics (PCM) ",
      degree: "CBSE(XII) - PCM ",
    },
    {
      id: 3,
      ...
      date: "2018-19",
      grade: "72.6%",
      desc: "I completed my class 10 education from Gurukul Public School, Aligarh, under the CBSE board, where I studied Science with Computer.",
